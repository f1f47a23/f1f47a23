...
- 🔭 I’m currently [working](https://github.com/f1f47a23/AWESOME) on xrp [ledger](https://xrpl.org/) client [app](https://github.com/f1f47a23/z1x-xrp-wallet) in full [freedom](https://youtu.be/A9tb2hm6Yms) to act as it more seems appropriate to me, following the thread of my inspiration, without having to follow orders or wishes of the usual incompetent idiots [🐒🐒🐒](https://youtu.be/_k8r7DUuJ-E) that plague the surface of this planet.
